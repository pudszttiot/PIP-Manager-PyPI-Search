...
class PipPackageManagerApp(QMainWindow):
    ...
    def install_package(self):
        ...
        if package_names:
            ...
            self.execute_command_with_loading(command, progress_bar_text=f"Installing {', '.join(package_names)}...")
    ...
    def uninstall_package(self):
        ...
        if package_names:
            ...
            self.execute_command_with_loading(command, progress_bar_text=f"Uninstalling {', '.join(package_names)}...")

    def upgrade_package(self):
        package_names = self.package_var.text().split(",")
        package_names = [pkg.strip() for pkg in package_names]
        if package_names:
            self.status_label.setText(f"Updating {', '.join(package_names)}...")
            command = f"pip install --upgrade {' '.join(package_names)}"
            self.execute_command_with_loading(command, progress_bar_text=f"Updating {', '.join(package_names)}...")
    ...
    def list_packages(self):
        ...
        command = "pip list"
        self.execute_command_with_loading(command, progress_bar_text="Creating List Of Installed Packages...")


    def check_outdated_packages(self):
        self.status_label.setText("Checking Outdated Packages...")
        command = "pip list --outdated"
        self.execute_command_with_loading(command, progress_bar_text="Checking For Outdated Packages...")
    ...
    def show_package_info(self):
        ...
        if package_name:
            ...
            self.execute_command_with_loading(command, progress_bar_text=f"Fetching Info For: {package_name}...")
    ...
    def output_outdated_to_requirements(self):
        ...
        try:
            ...
            self.execute_command_with_loading(command, progress_bar_text="Creating List Of Outdated Packages (outdated.txt)...")
    ...
    def output_installed_to_requirements(self):
        ...
        self.execute_command_with_loading(command, progress_bar_text="Creating List Of Installed Packages (installed.txt)...")
